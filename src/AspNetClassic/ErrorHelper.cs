using HotChocolate.AspNetClassic.Properties;
...
internal static class ErrorHelper
{
    public static IError InvalidRequest()
        => ErrorBuilder.New()
            .SetMessage(AspNetClassicResources.ErrorHelper_InvalidRequest)
            .SetCode(ErrorCodes.Server.RequestInvalid)
            .Build();

    public static IError RequestHasNoElements()
        => ErrorBuilder.New()
            .SetMessage(AspNetClassicResources.ErrorHelper_RequestHasNoElements)
            .SetCode(ErrorCodes.Server.RequestInvalid)
            .Build();
    ...
    public static IQueryResult ResponseTypeNotSupported()
        => QueryResultBuilder.CreateError(
            ErrorBuilder.New()
                .SetMessage(AspNetClassicResources.ErrorHelper_ResponseTypeNotSupported)
                .Build());
    ...
    public static IQueryResult UnknownSubscriptionError(Exception ex)
        => QueryResultBuilder.CreateError(
            ErrorBuilder
                ...
                .SetMessage(AspNetClassicResources.Subscription_SendResultsAsync)
                .Build());
