...
/// <summary>
/// The default authorization implementation that uses Microsoft.AspNetClassic.Authorization.
/// </summary>
public class DefaultAuthorizationHandler : IAuthorizationHandler
{
    /// <summary>
    /// Authorize current directive using Microsoft.AspNetClassic.Authorization.
    /// </summary>
